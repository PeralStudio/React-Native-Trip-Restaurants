    ...
    useEffect(() => {
        (async () => {
            ...
            if (statusPermissions !== 'granted') {
                toastRef.current.show('Tienes que aceptar los permisos de localizaciónpara crear un restaurante', 3000);
            } else {
        ...
        <Modal isVisible={isVisibleMap} setIsVisible={setIsVisibleMap}>
            <View>
                {location ? (
                    ...
                    <Text style={styles.textLoadingMap}>Cargando...</Text>
                }
    ...
    return (
        <View style={styles.viewPhoto}>
            <Image
                ...
                style={{ width: widthScreen, height: 180 }}
            />
        </View>
    );
};
...
const UploadImage = (props) => {
    ...
    const removeImage = (image) => {
        Alert.alert(
            "Eliminar Imagen",
            "¿Esta seguro que quiere eliminar la imagen?",
            [
                {
                    text: "Cancel",
                    style: "cancel",
